...
const CreateStoreSection = () => {
  return (
    <div className="mt-[10rem] lrg:h-screen w-5/6 shadow-custom my-20 lrg:my-40 flex justify-between items-center px-8 py-10 pt-4 pr-0 mid:pl-8 pl-0 rounded-2xl">
